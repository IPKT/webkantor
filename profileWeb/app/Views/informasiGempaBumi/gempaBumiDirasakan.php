<?= $this->extend('Layout/template_gempa_dirasakan');?>
...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        $query = $db->query('SELECT infogempa FROM gempabalidirasakan ORDER BY id DESC LIMIT 20');
...
$infoGempaTerakhir = "";
$db = \Config\Database::connect();
$query = $db->query('SELECT infogempa FROM gempabalidirasakan ORDER BY id DESC LIMIT 100');
$results   = $query->getResultArray();
$no = 1;
$warna = "";
foreach ($results as $row):
